...
@router.get("/professors", response_model=Ok[GetProfessorCoursesPaginatedResponse])
...
@router.get("/{course_id}/professors", response_model=Ok[GetCourseDetailProfessorResponse])
async def get_course_detail_for_professor(
    ...
    # Lấy thông tin bài học trong khóa học
    ...
    # Xây dựng response cho khóa học
